...
main()
{
	...
	for(int oddcount = 0, evencount = 0, count = 0; count<length; count++)
	{
	...
	printArr1D(eventhingy,length);
	cout<<"Yall the ODD numbers...\n";
	printArr1D(oddthingy, length);
	cout<<"Apologies for the extra zeroes in the end"<<endl;
}
